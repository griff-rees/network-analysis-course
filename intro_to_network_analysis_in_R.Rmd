...
We're going to focus on the iGraph package for today. There are *many* other pacakges: LIST but this is a fairly comprehensive one for getting started. I recommend looking through the iGraph documentation for your particular interests before trying the other packages, and feel free to email me with questions (helpful if you can be specific what you're trying to achieve).

...
We're going to focus on the iGraph R package for today. There are *many* other options: 

* R
    + [iGraph](https://igraph.org/r/) built on C++ library, easier to get started and pre-dates ggplot so provides it's own visualisation options
    + [statnet](http://statnet.org/) focused particularly on exponential random graphs (ERG) methods, maintained by [Prof Carter T. Butts](https://scholar.google.co.uk/citations?user=-VGAs1cAAAAJ&hl=en)
...
* Python (my language of choice)
    ...
    + [graph-tool](https://graph-tool.skewed.de/) Much newer, very speed efficient (C++ underneath)
* Windows
    + [UCINET](https://sites.google.com/site/ucinetsoftware/home) windows, developed and maintaied by 

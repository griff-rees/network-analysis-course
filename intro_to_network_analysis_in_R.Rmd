...
* `ggnetwork`: `R` package for use with `ggplot`
...
edge_density(g)
```
<!-- mention difference of subgraphs and how this consideres disconnected nodes-->

## Reciprocity (cue Laryn Hill's *Ex-Factor*)

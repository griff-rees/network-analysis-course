...
V(h)$color[V(h)$name %in% other] <- "green"
...
As mentioned in a [previous section](#load-CSVs) there are two components of data for each node:
...
The `name` attribute is particularly helpful in
